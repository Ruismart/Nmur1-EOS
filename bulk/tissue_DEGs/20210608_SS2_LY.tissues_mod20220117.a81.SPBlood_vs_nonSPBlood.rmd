...
Aidx = grep("SP|Blood",colnames(mat_pc))
Bidx = grep("SP|Blood",colnames(mat_pc),invert = T)
...
```{r eval=FALSE, include=FALSE}
write.table(rec_gcol(data.frame(ret$DEG_edgeR)), paste0("edgeR_DEGs.tissues_a81_",
